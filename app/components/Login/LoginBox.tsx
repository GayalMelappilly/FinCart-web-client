...
const LoginBox: FC<Props> = ({ isLoading, setIsLoading }) => {
                ...
                <div>
                    ...
                    <div className="mb-6 flex items-center justify-between">
                        ...
                        <div className="text-sm">
                            <Link href={{pathname: "/login/forgot-password", query: {email: identifier}}} className="font-medium text-blue-600 hover:text-blue-500">
                                Forgot password?
                            </Link>
                        </div>
                    </div>
